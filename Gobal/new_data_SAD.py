...
def test_new_data(
    ...
    for i in range(len(samples)):
        ...
        bz1 = [1.0]
        bz = np.array(bz1)
        output = net.forward(zsimg_tensor)
...
if __name__ == "__main__":
    ...
    # load_model_path = "v20230223/dvmm/models/14resnet_3fc_rgb17wos4_4/d0.5_n0.5_shuffle" # GM
    load_model_path = "v20220819/saliencyaddgazemmwos4/models/14resnetmm_3fc_rgb17wos4/d0.5_n0.5_shuffle"

    ml_vote_path = "v20220819/saliencyaddgazemmwos4/output/14resnetmm_3fc_rgb17wos4/d0.5_n0.5_shuffle_4/64_1e-06"

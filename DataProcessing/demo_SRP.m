...
addpath( genpath( 'E:\ASD_eyetracking\datapy\Code-for-SRP-Method-master' ) );

datasetPath = 'E:\ASD_eyetracking\datapy\Code-for-SRP-Method-master\data\RGB';% input rgb data

OF_SUP_Path = 'E:\ASD_eyetracking\datapy\Code-for-SRP-Method-master\results\OpticalFlow_SLIC500';

% mkdir(OF_SUP_Path);
rsultsetPath = 'E:\ASD_eyetracking\datapy\Code-for-SRP-Method-master\results\SRP';
% mkdir(rsultsetPath);
run('E:\ASD_eyetracking\datapy\Code-for-SRP-Method-master\vlfeat-0.9.21\toolbox\vl_setup')

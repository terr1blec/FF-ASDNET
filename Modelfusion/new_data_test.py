...
import torch
import cv2
from dataloader import pallmediaMyDataset, _collate_fn, testpallmediaMyDataset
import model
...
def test_new_data(
    ...
    for i in range(len(samples)):
        ...
        bz1 = [1.0]
        bz = np.array(bz1)
        output = net.forward(dvimg_tensor, zsimg_tensor, limg_tensor, bz, 0)
...
def load_net(round, dvmodelpath, zsmodelpath, lmodelpath, load_model_path, number, lr):
    ...
    pathfiles = os.listdir(f"{load_model_path}/{i}/64_{str(lr)}")

    net = model.dvzsfusionconv_lf_fccon(
        dvpath,
        zspath,
        lpath=lpath,
        dvzspath=dvzspath,
    ...
    for file in pathfiles:
        if file[5:7] == str(number):
            pathfile = f"{load_model_path}/{i}/64_{str(lr)}/{file}"
...
if __name__ == "__main__":
    ...
    # load_model_path = "v20240316/dv_zssa_l/models/l_5fc_padding_d0.5_convcon_conv512_1*1_conv256_3*3_update_1loss_3fc/d0.5_n0.5_shuffle"
    load_model_path = "v20230320/dv_zssa_l/models/l_5fc_padding_d0.5_convcon_conv512_1*1_conv256_3*3_update_1loss_3fc/d0.5_n0.5_shuffle"
    # load_model_path = "v20240402/dv_zssa_l/models/l_5fc_padding_d0.5_convcon_conv512_1*1_conv256_3*3_update_1loss_3fc/d0.5_n0.5_shuffle"

    # ml_vote_path = "v20240316/dv_zssa_l/output/l_5fc_padding_d0.5_convcon_conv512_1*1_conv256_3*3_update_1loss_3fc/d0.5_n0.5_shuffle_4/64_1e-06"
    ml_vote_path = "v20230320/dv_zssa_l/output/l_5fc_padding_d0.5_convcon_conv512_1*1_conv256_3*3_update_1loss_3fc/d0.5_n0.5_shuffle_4/64_5e-07"
    ...
    for lb in lb34:
        ...
        for d in fcd3:
            ...
            for i in I:
                ...
                fpr_tpr = hard_fpr_tpr+soft_fpr_tpr+bestsort_fpr_tpr+ml_fpr_tpr
                print(fpr_tpr)
                plot_auc(fpr_tpr)

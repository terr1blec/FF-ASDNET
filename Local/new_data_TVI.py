...
def test_new_data(
    ...
    for i in range(len(samples)):
        ...
        bz1 = [1.0]
        bz = np.array(bz1)
        output = net.forward(limg_tensor,bz,1)
...
def load_net(round, dvmodelpath, zsmodelpath, lmodelpath, load_model_path, number, lr):
    ...
    net = model.conv2dconv1drpadding(1024, 2048, [2, 2, 2, 2]) 
    net.cuda()
    _ = net.eval()
...
if __name__ == "__main__":
    ...
    load_model_path = "v20230316/models/conv2dconv1d_rconv1d1024(321)_2048(521)_17wos4_BN_3fc_rgb_d0.5_shuffle_"

    ml_vote_path = "v20230316/output/conv2dconv1d_rconv1d1024(321)_2048(521)_17wos4_BN_3fc_rgb_d0.5_shuffle__4/32_1e-06"
